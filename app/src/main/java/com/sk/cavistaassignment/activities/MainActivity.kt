...
import com.sk.cavistaassignment.adapters.ImageListAdapter
import com.sk.cavistaassignment.model.Data
import com.sk.cavistaassignment.viewModels.MainActivityViewModel
...
class MainActivity : AppCompatActivity(), ImageListAdapter.OnClickListener {
    ...
    private fun getSearchImage(text: String?) {
        CoroutineScope(Dispatchers.Main).launch {
            text?.let { mainActivityViewModel.getImages(this@MainActivity, it, false) }
        }
    }
